...
func TestPointEd25519Random(t *testing.T) {
	...
	require.True(t, ok)
	expected := toRPt("da754457c0b28c8fca940da7ad67b5476208a73e8c65c3aab0b833c3b9b61346")
...
func TestPointEd25519Hash(t *testing.T) {
	...
	s, ok := sc.(*PointEd25519)
	require.True(t, ok)
	expected := toRPt("4838562f360e7087a5b2c6e867836ab6dd3b8d20c923eb2b535902739060bf09")
	require.True(t, s.Equal(&PointEd25519{expected}))
...
func TestPointEd25519Set(t *testing.T) {
	...
	x := new(big.Int).SetBytes(internal.ReverseBytes(xBytes))
	y := new(big.Int).SetBytes(internal.ReverseBytes(yBytes))
	...
	emptyX := new(big.Int).SetBytes(internal.ReverseBytes([]byte{}))
