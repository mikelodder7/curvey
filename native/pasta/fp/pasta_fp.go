...
type (
	fiatPastaFpUint1 uint64 // We use uint64 instead of a more narrow type for performance reasons; see https://github.com/mit-plv/fiat-crypto/pull/1006#issuecomment-892625927
	fiatPastaFpInt1  int64  // We use uint64 instead of a more narrow type for performance reasons; see https://github.com/mit-plv/fiat-crypto/pull/1006#issuecomment-892625927
)

// The type fiatPastaFpMontgomeryDomainFieldElement is a field element in the Montgomery domain.
//
// Bounds: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]].
type fiatPastaFpMontgomeryDomainFieldElement [4]uint64

// The type fiatPastaFpNonMontgomeryDomainFieldElement is a field element NOT in the Montgomery domain.
//
// Bounds: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]].
type fiatPastaFpNonMontgomeryDomainFieldElement [4]uint64

// The function fiatPastaFpAddcarryxU64 is a thin wrapper around bits.Add64 that uses fiat_pasta_fp_uint1 rather than uint64.
func fiatPastaFpAddcarryxU64(x, y uint64, carry fiatPastaFpUint1) (uint64, fiatPastaFpUint1) {
	sum, carryOut := bits.Add64(x, y, uint64(carry))
	return sum, fiatPastaFpUint1(carryOut)
}

// The function fiatPastaFpSubborrowxU64 is a thin wrapper around bits.Sub64 that uses fiat_pasta_fp_uint1 rather than uint64.
func fiatPastaFpSubborrowxU64(x, y uint64, carry fiatPastaFpUint1) (uint64, fiatPastaFpUint1) {
...
func fiatPastaPpMul(out1, arg1, arg2 *fiatPastaFpMontgomeryDomainFieldElement) {
	...
	x13, x14 = fiatPastaFpAddcarryxU64(x12, x9, 0x0)
	var x15 uint64
	var x16 fiatPastaFpUint1
	x15, x16 = fiatPastaFpAddcarryxU64(x10, x7, x14)
	var x17 uint64
	var x18 fiatPastaFpUint1
	x17, x18 = fiatPastaFpAddcarryxU64(x8, x5, x16)
	x19 := (uint64(x18) + x6)
	var x20 uint64
	...
	x28, x29 = fiatPastaFpAddcarryxU64(x27, x24, 0x0)
	x30 := (uint64(x29) + x25)
	var x32 fiatPastaFpUint1
	_, x32 = fiatPastaFpAddcarryxU64(x11, x26, 0x0)
	var x33 uint64
	var x34 fiatPastaFpUint1
	x33, x34 = fiatPastaFpAddcarryxU64(x13, x28, x32)
	var x35 uint64
	var x36 fiatPastaFpUint1
	x35, x36 = fiatPastaFpAddcarryxU64(x15, x30, x34)
	var x37 uint64
	var x38 fiatPastaFpUint1
	x37, x38 = fiatPastaFpAddcarryxU64(x17, x22, x36)
	var x39 uint64
	var x40 fiatPastaFpUint1
	x39, x40 = fiatPastaFpAddcarryxU64(x19, x23, x38)
	var x41 uint64
	var x42 uint64
	...
	x49, x50 = fiatPastaFpAddcarryxU64(x48, x45, 0x0)
	var x51 uint64
	var x52 fiatPastaFpUint1
	x51, x52 = fiatPastaFpAddcarryxU64(x46, x43, x50)
	var x53 uint64
	var x54 fiatPastaFpUint1
	x53, x54 = fiatPastaFpAddcarryxU64(x44, x41, x52)
	x55 := (uint64(x54) + x42)
	var x56 uint64
	var x57 fiatPastaFpUint1
	x56, x57 = fiatPastaFpAddcarryxU64(x33, x47, 0x0)
	var x58 uint64
	var x59 fiatPastaFpUint1
	x58, x59 = fiatPastaFpAddcarryxU64(x35, x49, x57)
	var x60 uint64
	var x61 fiatPastaFpUint1
	x60, x61 = fiatPastaFpAddcarryxU64(x37, x51, x59)
	var x62 uint64
	var x63 fiatPastaFpUint1
	x62, x63 = fiatPastaFpAddcarryxU64(x39, x53, x61)
	var x64 uint64
	var x65 fiatPastaFpUint1
	x64, x65 = fiatPastaFpAddcarryxU64(uint64(x40), x55, x63)
	var x66 uint64
	...
	x74, x75 = fiatPastaFpAddcarryxU64(x73, x70, 0x0)
	x76 := (uint64(x75) + x71)
	var x78 fiatPastaFpUint1
	_, x78 = fiatPastaFpAddcarryxU64(x56, x72, 0x0)
	var x79 uint64
	var x80 fiatPastaFpUint1
	x79, x80 = fiatPastaFpAddcarryxU64(x58, x74, x78)
	var x81 uint64
	var x82 fiatPastaFpUint1
	x81, x82 = fiatPastaFpAddcarryxU64(x60, x76, x80)
	var x83 uint64
	var x84 fiatPastaFpUint1
	x83, x84 = fiatPastaFpAddcarryxU64(x62, x68, x82)
	var x85 uint64
	var x86 fiatPastaFpUint1
	x85, x86 = fiatPastaFpAddcarryxU64(x64, x69, x84)
	...
	x96, x97 = fiatPastaFpAddcarryxU64(x95, x92, 0x0)
	var x98 uint64
	var x99 fiatPastaFpUint1
	x98, x99 = fiatPastaFpAddcarryxU64(x93, x90, x97)
	var x100 uint64
	var x101 fiatPastaFpUint1
	x100, x101 = fiatPastaFpAddcarryxU64(x91, x88, x99)
	x102 := (uint64(x101) + x89)
	var x103 uint64
	var x104 fiatPastaFpUint1
	x103, x104 = fiatPastaFpAddcarryxU64(x79, x94, 0x0)
	var x105 uint64
	var x106 fiatPastaFpUint1
	x105, x106 = fiatPastaFpAddcarryxU64(x81, x96, x104)
	var x107 uint64
	var x108 fiatPastaFpUint1
	x107, x108 = fiatPastaFpAddcarryxU64(x83, x98, x106)
	var x109 uint64
	var x110 fiatPastaFpUint1
	x109, x110 = fiatPastaFpAddcarryxU64(x85, x100, x108)
	var x111 uint64
	var x112 fiatPastaFpUint1
	x111, x112 = fiatPastaFpAddcarryxU64(x87, x102, x110)
	var x113 uint64
	...
	x121, x122 = fiatPastaFpAddcarryxU64(x120, x117, 0x0)
	x123 := (uint64(x122) + x118)
	var x125 fiatPastaFpUint1
	_, x125 = fiatPastaFpAddcarryxU64(x103, x119, 0x0)
	var x126 uint64
	var x127 fiatPastaFpUint1
	x126, x127 = fiatPastaFpAddcarryxU64(x105, x121, x125)
	var x128 uint64
	var x129 fiatPastaFpUint1
	x128, x129 = fiatPastaFpAddcarryxU64(x107, x123, x127)
	var x130 uint64
	var x131 fiatPastaFpUint1
	x130, x131 = fiatPastaFpAddcarryxU64(x109, x115, x129)
	var x132 uint64
	var x133 fiatPastaFpUint1
	x132, x133 = fiatPastaFpAddcarryxU64(x111, x116, x131)
	...
	x143, x144 = fiatPastaFpAddcarryxU64(x142, x139, 0x0)
	var x145 uint64
	var x146 fiatPastaFpUint1
	x145, x146 = fiatPastaFpAddcarryxU64(x140, x137, x144)
	var x147 uint64
	var x148 fiatPastaFpUint1
	x147, x148 = fiatPastaFpAddcarryxU64(x138, x135, x146)
	x149 := (uint64(x148) + x136)
	var x150 uint64
	var x151 fiatPastaFpUint1
	x150, x151 = fiatPastaFpAddcarryxU64(x126, x141, 0x0)
	var x152 uint64
	var x153 fiatPastaFpUint1
	x152, x153 = fiatPastaFpAddcarryxU64(x128, x143, x151)
	var x154 uint64
	var x155 fiatPastaFpUint1
	x154, x155 = fiatPastaFpAddcarryxU64(x130, x145, x153)
	var x156 uint64
	var x157 fiatPastaFpUint1
	x156, x157 = fiatPastaFpAddcarryxU64(x132, x147, x155)
	var x158 uint64
	var x159 fiatPastaFpUint1
	x158, x159 = fiatPastaFpAddcarryxU64(x134, x149, x157)
	var x160 uint64
	...
	x168, x169 = fiatPastaFpAddcarryxU64(x167, x164, 0x0)
	x170 := (uint64(x169) + x165)
	var x172 fiatPastaFpUint1
	_, x172 = fiatPastaFpAddcarryxU64(x150, x166, 0x0)
	var x173 uint64
	var x174 fiatPastaFpUint1
	x173, x174 = fiatPastaFpAddcarryxU64(x152, x168, x172)
	var x175 uint64
	var x176 fiatPastaFpUint1
	x175, x176 = fiatPastaFpAddcarryxU64(x154, x170, x174)
	var x177 uint64
	var x178 fiatPastaFpUint1
	x177, x178 = fiatPastaFpAddcarryxU64(x156, x162, x176)
	var x179 uint64
	var x180 fiatPastaFpUint1
	x179, x180 = fiatPastaFpAddcarryxU64(x158, x163, x178)
	x181 := (uint64(x180) + uint64(x159))
	var x182 uint64
	var x183 fiatPastaFpUint1
	x182, x183 = fiatPastaFpSubborrowxU64(x173, 0x992d30ed00000001, 0x0)
	var x184 uint64
	var x185 fiatPastaFpUint1
	x184, x185 = fiatPastaFpSubborrowxU64(x175, 0x224698fc094cf91b, x183)
	var x186 uint64
	var x187 fiatPastaFpUint1
	x186, x187 = fiatPastaFpSubborrowxU64(x177, uint64(0x0), x185)
	var x188 uint64
	var x189 fiatPastaFpUint1
	x188, x189 = fiatPastaFpSubborrowxU64(x179, 0x4000000000000000, x187)
	var x191 fiatPastaFpUint1
	_, x191 = fiatPastaFpSubborrowxU64(x181, uint64(0x0), x189)
	var x192 uint64
...
func fiatPastaFpAdd(out1, arg1, arg2 *fiatPastaFpMontgomeryDomainFieldElement) {
	...
	x1, x2 = fiatPastaFpAddcarryxU64(arg1[0], arg2[0], 0x0)
	var x3 uint64
	var x4 fiatPastaFpUint1
	x3, x4 = fiatPastaFpAddcarryxU64(arg1[1], arg2[1], x2)
	var x5 uint64
	var x6 fiatPastaFpUint1
	x5, x6 = fiatPastaFpAddcarryxU64(arg1[2], arg2[2], x4)
	var x7 uint64
	var x8 fiatPastaFpUint1
	x7, x8 = fiatPastaFpAddcarryxU64(arg1[3], arg2[3], x6)
	var x9 uint64
	var x10 fiatPastaFpUint1
	x9, x10 = fiatPastaFpSubborrowxU64(x1, 0x992d30ed00000001, 0x0)
	var x11 uint64
	var x12 fiatPastaFpUint1
	x11, x12 = fiatPastaFpSubborrowxU64(x3, 0x224698fc094cf91b, x10)
	var x13 uint64
	var x14 fiatPastaFpUint1
	x13, x14 = fiatPastaFpSubborrowxU64(x5, uint64(0x0), x12)
	var x15 uint64
	var x16 fiatPastaFpUint1
	x15, x16 = fiatPastaFpSubborrowxU64(x7, 0x4000000000000000, x14)
	var x18 fiatPastaFpUint1
	_, x18 = fiatPastaFpSubborrowxU64(uint64(x8), uint64(0x0), x16)
	var x19 uint64
...
func fiatPastaFpSub(out1, arg1, arg2 *fiatPastaFpMontgomeryDomainFieldElement) {
	var x1 uint64
	var x2 fiatPastaFpUint1
	x1, x2 = fiatPastaFpSubborrowxU64(arg1[0], arg2[0], 0x0)
	var x3 uint64
	var x4 fiatPastaFpUint1
	x3, x4 = fiatPastaFpSubborrowxU64(arg1[1], arg2[1], x2)
	var x5 uint64
	var x6 fiatPastaFpUint1
	x5, x6 = fiatPastaFpSubborrowxU64(arg1[2], arg2[2], x4)
	var x7 uint64
	var x8 fiatPastaFpUint1
	x7, x8 = fiatPastaFpSubborrowxU64(arg1[3], arg2[3], x6)
	var x9 uint64
	fiatPastaFpCmovznzU64(&x9, x8, uint64(0x0), 0xffffffffffffffff)
	var x10 uint64
	var x11 fiatPastaFpUint1
	x10, x11 = fiatPastaFpAddcarryxU64(x1, (x9 & 0x992d30ed00000001), 0x0)
	var x12 uint64
	var x13 fiatPastaFpUint1
	x12, x13 = fiatPastaFpAddcarryxU64(x3, (x9 & 0x224698fc094cf91b), x11)
	var x14 uint64
	var x15 fiatPastaFpUint1
	x14, x15 = fiatPastaFpAddcarryxU64(x5, uint64(0x0), x13)
	var x16 uint64
	x16, _ = fiatPastaFpAddcarryxU64(x7, (x9 & 0x4000000000000000), x15)
	out1[0] = x10
	out1[1] = x12
	out1[2] = x14
	out1[3] = x16
...
func fiatPastaFpOpp(out1, arg1 *fiatPastaFpMontgomeryDomainFieldElement) {
	var x1 uint64
	var x2 fiatPastaFpUint1
	x1, x2 = fiatPastaFpSubborrowxU64(uint64(0x0), arg1[0], 0x0)
	var x3 uint64
	var x4 fiatPastaFpUint1
	x3, x4 = fiatPastaFpSubborrowxU64(uint64(0x0), arg1[1], x2)
	var x5 uint64
	var x6 fiatPastaFpUint1
	x5, x6 = fiatPastaFpSubborrowxU64(uint64(0x0), arg1[2], x4)
	var x7 uint64
	var x8 fiatPastaFpUint1
	x7, x8 = fiatPastaFpSubborrowxU64(uint64(0x0), arg1[3], x6)
	var x9 uint64
	fiatPastaFpCmovznzU64(&x9, x8, uint64(0x0), 0xffffffffffffffff)
	var x10 uint64
	var x11 fiatPastaFpUint1
...
func fiatPastaFpFromMontgomery(out1 *fiatPastaFpNonMontgomeryDomainFieldElement, arg1 *fiatPastaFpMontgomeryDomainFieldElement) {
	...
	var x10 uint64
	var x11 fiatPastaFpUint1
	x10, x11 = fiatPastaFpAddcarryxU64(x9, x6, 0x0)
	var x13 fiatPastaFpUint1
	_, x13 = fiatPastaFpAddcarryxU64(x1, x8, 0x0)
	var x14 uint64
	var x15 fiatPastaFpUint1
	x14, x15 = fiatPastaFpAddcarryxU64(uint64(0x0), x10, x13)
	var x16 uint64
	var x17 fiatPastaFpUint1
	x16, x17 = fiatPastaFpAddcarryxU64(x14, arg1[1], 0x0)
	var x18 uint64
	...
	x26, x27 = fiatPastaFpAddcarryxU64(x25, x22, 0x0)
	var x29 fiatPastaFpUint1
	_, x29 = fiatPastaFpAddcarryxU64(x16, x24, 0x0)
	var x30 uint64
	var x31 fiatPastaFpUint1
	x30, x31 = fiatPastaFpAddcarryxU64((uint64(x17) + (uint64(x15) + (uint64(x11) + x7))), x26, x29)
	var x32 uint64
	var x33 fiatPastaFpUint1
	x32, x33 = fiatPastaFpAddcarryxU64(x4, (uint64(x27) + x23), x31)
	var x34 uint64
	var x35 fiatPastaFpUint1
	x34, x35 = fiatPastaFpAddcarryxU64(x5, x20, x33)
	var x36 uint64
	var x37 fiatPastaFpUint1
	x36, x37 = fiatPastaFpAddcarryxU64(x30, arg1[2], 0x0)
	var x38 uint64
	var x39 fiatPastaFpUint1
	x38, x39 = fiatPastaFpAddcarryxU64(x32, uint64(0x0), x37)
	var x40 uint64
	var x41 fiatPastaFpUint1
	x40, x41 = fiatPastaFpAddcarryxU64(x34, uint64(0x0), x39)
	var x42 uint64
	...
	x50, x51 = fiatPastaFpAddcarryxU64(x49, x46, 0x0)
	var x53 fiatPastaFpUint1
	_, x53 = fiatPastaFpAddcarryxU64(x36, x48, 0x0)
	var x54 uint64
	var x55 fiatPastaFpUint1
	x54, x55 = fiatPastaFpAddcarryxU64(x38, x50, x53)
	var x56 uint64
	var x57 fiatPastaFpUint1
	x56, x57 = fiatPastaFpAddcarryxU64(x40, (uint64(x51) + x47), x55)
	var x58 uint64
	var x59 fiatPastaFpUint1
	x58, x59 = fiatPastaFpAddcarryxU64((uint64(x41) + (uint64(x35) + x21)), x44, x57)
	var x60 uint64
	var x61 fiatPastaFpUint1
	x60, x61 = fiatPastaFpAddcarryxU64(x54, arg1[3], 0x0)
	var x62 uint64
	var x63 fiatPastaFpUint1
	x62, x63 = fiatPastaFpAddcarryxU64(x56, uint64(0x0), x61)
	var x64 uint64
	var x65 fiatPastaFpUint1
	x64, x65 = fiatPastaFpAddcarryxU64(x58, uint64(0x0), x63)
	var x66 uint64
	...
	_, x77 = fiatPastaFpAddcarryxU64(x60, x72, 0x0)
	var x78 uint64
	var x79 fiatPastaFpUint1
	x78, x79 = fiatPastaFpAddcarryxU64(x62, x74, x77)
	var x80 uint64
	var x81 fiatPastaFpUint1
	x80, x81 = fiatPastaFpAddcarryxU64(x64, (uint64(x75) + x71), x79)
	var x82 uint64
	var x83 fiatPastaFpUint1
	x82, x83 = fiatPastaFpAddcarryxU64((uint64(x65) + (uint64(x59) + x45)), x68, x81)
	x84 := (uint64(x83) + x69)
	var x85 uint64
	var x86 fiatPastaFpUint1
	x85, x86 = fiatPastaFpSubborrowxU64(x78, 0x992d30ed00000001, 0x0)
	var x87 uint64
	var x88 fiatPastaFpUint1
	x87, x88 = fiatPastaFpSubborrowxU64(x80, 0x224698fc094cf91b, x86)
	var x89 uint64
	var x90 fiatPastaFpUint1
	x89, x90 = fiatPastaFpSubborrowxU64(x82, uint64(0x0), x88)
	var x91 uint64
	var x92 fiatPastaFpUint1
	x91, x92 = fiatPastaFpSubborrowxU64(x84, 0x4000000000000000, x90)
	var x94 fiatPastaFpUint1
	_, x94 = fiatPastaFpSubborrowxU64(uint64(0x0), uint64(0x0), x92)
	var x95 uint64
...
func fiatPastaFpToMontgomery(out1 *fiatPastaFpMontgomeryDomainFieldElement, arg1 *fiatPastaFpNonMontgomeryDomainFieldElement) {
	...
	x27, x28 = fiatPastaFpAddcarryxU64(x26, x23, 0x0)
	var x30 fiatPastaFpUint1
	_, x30 = fiatPastaFpAddcarryxU64(x11, x25, 0x0)
	var x31 uint64
	var x32 fiatPastaFpUint1
	x31, x32 = fiatPastaFpAddcarryxU64(x13, x27, x30)
	var x33 uint64
	var x34 fiatPastaFpUint1
	x33, x34 = fiatPastaFpAddcarryxU64(x15, (uint64(x28) + x24), x32)
	var x35 uint64
	var x36 fiatPastaFpUint1
	x35, x36 = fiatPastaFpAddcarryxU64(x17, x21, x34)
	var x37 uint64
	var x38 uint64
	...
	x45, x46 = fiatPastaFpAddcarryxU64(x44, x41, 0x0)
	var x47 uint64
	var x48 fiatPastaFpUint1
	x47, x48 = fiatPastaFpAddcarryxU64(x42, x39, x46)
	var x49 uint64
	var x50 fiatPastaFpUint1
	x49, x50 = fiatPastaFpAddcarryxU64(x40, x37, x48)
	var x51 uint64
	var x52 fiatPastaFpUint1
	x51, x52 = fiatPastaFpAddcarryxU64(x31, x43, 0x0)
	var x53 uint64
	var x54 fiatPastaFpUint1
	x53, x54 = fiatPastaFpAddcarryxU64(x33, x45, x52)
	var x55 uint64
	var x56 fiatPastaFpUint1
	x55, x56 = fiatPastaFpAddcarryxU64(x35, x47, x54)
	var x57 uint64
	var x58 fiatPastaFpUint1
	x57, x58 = fiatPastaFpAddcarryxU64(((uint64(x36) + (uint64(x18) + x6)) + x22), x49, x56)
	var x59 uint64
	...
	x67, x68 = fiatPastaFpAddcarryxU64(x66, x63, 0x0)
	var x70 fiatPastaFpUint1
	_, x70 = fiatPastaFpAddcarryxU64(x51, x65, 0x0)
	var x71 uint64
	var x72 fiatPastaFpUint1
	x71, x72 = fiatPastaFpAddcarryxU64(x53, x67, x70)
	var x73 uint64
	var x74 fiatPastaFpUint1
	x73, x74 = fiatPastaFpAddcarryxU64(x55, (uint64(x68) + x64), x72)
	var x75 uint64
	var x76 fiatPastaFpUint1
	x75, x76 = fiatPastaFpAddcarryxU64(x57, x61, x74)
	var x77 uint64
	var x78 uint64
	...
	var x85 uint64
	var x86 fiatPastaFpUint1
	x85, x86 = fiatPastaFpAddcarryxU64(x84, x81, 0x0)
	var x87 uint64
	var x88 fiatPastaFpUint1
	x87, x88 = fiatPastaFpAddcarryxU64(x82, x79, x86)
	var x89 uint64
	var x90 fiatPastaFpUint1
	x89, x90 = fiatPastaFpAddcarryxU64(x80, x77, x88)
	var x91 uint64
	var x92 fiatPastaFpUint1
	x91, x92 = fiatPastaFpAddcarryxU64(x71, x83, 0x0)
	var x93 uint64
	var x94 fiatPastaFpUint1
	x93, x94 = fiatPastaFpAddcarryxU64(x73, x85, x92)
	var x95 uint64
	var x96 fiatPastaFpUint1
	x95, x96 = fiatPastaFpAddcarryxU64(x75, x87, x94)
	var x97 uint64
	var x98 fiatPastaFpUint1
	x97, x98 = fiatPastaFpAddcarryxU64(((uint64(x76) + (uint64(x58) + (uint64(x50) + x38))) + x62), x89, x96)
	var x99 uint64
	...
	var x107 uint64
	var x108 fiatPastaFpUint1
	x107, x108 = fiatPastaFpAddcarryxU64(x106, x103, 0x0)
	var x110 fiatPastaFpUint1
	_, x110 = fiatPastaFpAddcarryxU64(x91, x105, 0x0)
	var x111 uint64
	var x112 fiatPastaFpUint1
	x111, x112 = fiatPastaFpAddcarryxU64(x93, x107, x110)
	var x113 uint64
	var x114 fiatPastaFpUint1
	x113, x114 = fiatPastaFpAddcarryxU64(x95, (uint64(x108) + x104), x112)
	var x115 uint64
	var x116 fiatPastaFpUint1
	x115, x116 = fiatPastaFpAddcarryxU64(x97, x101, x114)
	var x117 uint64
	var x118 uint64
	...
	x125, x126 = fiatPastaFpAddcarryxU64(x124, x121, 0x0)
	var x127 uint64
	var x128 fiatPastaFpUint1
	x127, x128 = fiatPastaFpAddcarryxU64(x122, x119, x126)
	var x129 uint64
	var x130 fiatPastaFpUint1
	x129, x130 = fiatPastaFpAddcarryxU64(x120, x117, x128)
	var x131 uint64
	var x132 fiatPastaFpUint1
	x131, x132 = fiatPastaFpAddcarryxU64(x111, x123, 0x0)
	var x133 uint64
	var x134 fiatPastaFpUint1
	x133, x134 = fiatPastaFpAddcarryxU64(x113, x125, x132)
	var x135 uint64
	var x136 fiatPastaFpUint1
	x135, x136 = fiatPastaFpAddcarryxU64(x115, x127, x134)
	var x137 uint64
	var x138 fiatPastaFpUint1
	x137, x138 = fiatPastaFpAddcarryxU64(((uint64(x116) + (uint64(x98) + (uint64(x90) + x78))) + x102), x129, x136)
	var x139 uint64
	...
	var x147 uint64
	var x148 fiatPastaFpUint1
	x147, x148 = fiatPastaFpAddcarryxU64(x146, x143, 0x0)
	var x150 fiatPastaFpUint1
	_, x150 = fiatPastaFpAddcarryxU64(x131, x145, 0x0)
	var x151 uint64
	var x152 fiatPastaFpUint1
	x151, x152 = fiatPastaFpAddcarryxU64(x133, x147, x150)
	var x153 uint64
	var x154 fiatPastaFpUint1
	x153, x154 = fiatPastaFpAddcarryxU64(x135, (uint64(x148) + x144), x152)
	var x155 uint64
	var x156 fiatPastaFpUint1
	x155, x156 = fiatPastaFpAddcarryxU64(x137, x141, x154)
	x157 := ((uint64(x156) + (uint64(x138) + (uint64(x130) + x118))) + x142)
	var x158 uint64
	var x159 fiatPastaFpUint1
	x158, x159 = fiatPastaFpSubborrowxU64(x151, 0x992d30ed00000001, 0x0)
	var x160 uint64
	var x161 fiatPastaFpUint1
	x160, x161 = fiatPastaFpSubborrowxU64(x153, 0x224698fc094cf91b, x159)
	var x162 uint64
	var x163 fiatPastaFpUint1
	x162, x163 = fiatPastaFpSubborrowxU64(x155, uint64(0x0), x161)
	var x164 uint64
	var x165 fiatPastaFpUint1
	x164, x165 = fiatPastaFpSubborrowxU64(x157, 0x4000000000000000, x163)
	var x167 fiatPastaFpUint1
	_, x167 = fiatPastaFpSubborrowxU64(uint64(0x0), uint64(0x0), x165)
	var x168 uint64
