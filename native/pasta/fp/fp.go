...
var (
	...
	pastaFpParams   native.FieldParams
)

func PastaFpNew() *native.Field {
	return &native.Field{
...
func pastaFpParamsInit() {
	pastaFpParams = native.FieldParams{
		R:       [native.FieldLimbs]uint64{0x34786d38fffffffd, 0x992c350be41914ad, 0xffffffffffffffff, 0x3fffffffffffffff},
		R2:      [native.FieldLimbs]uint64{0x8c78ecb30000000f, 0xd7d30dbd8b0de0e7, 0x7797a99bc3c95d18, 0x096d41af7b9cb714},
		R3:      [native.FieldLimbs]uint64{0xf185a5993a9e10f9, 0xf6a68f3b6ac5b1d1, 0xdf8d1014353fd42c, 0x2ae309222d2d9910},
		Modulus: [native.FieldLimbs]uint64{0x992d30ed00000001, 0x224698fc094cf91b, 0x0000000000000000, 0x4000000000000000},
...
func GetPastaFpParams() *native.FieldParams {
...
func (PastaFpArithmetic) Add(out, arg1, arg2 *[native.FieldLimbs]uint64) {
	fiatPastaFpAdd(
		(*fiatPastaFpMontgomeryDomainFieldElement)(out),
		(*fiatPastaFpMontgomeryDomainFieldElement)(arg1),
		(*fiatPastaFpMontgomeryDomainFieldElement)(arg2),
...
func (PastaFpArithmetic) Sub(out, arg1, arg2 *[native.FieldLimbs]uint64) {
	fiatPastaFpSub(
		(*fiatPastaFpMontgomeryDomainFieldElement)(out),
		(*fiatPastaFpMontgomeryDomainFieldElement)(arg1),
		(*fiatPastaFpMontgomeryDomainFieldElement)(arg2),
...
func (f PastaFpArithmetic) Sqrt(wasSquare *int, out, arg *[native.FieldLimbs]uint64) {
	// c1 := 32
	// c2 := (q - 1) / (2^c1)
	// c2 := [4]uint64{
	// 	0x094cf91b992d30ed,
...
func (f PastaFpArithmetic) Invert(wasInverted *int, out, arg *[native.FieldLimbs]uint64) {
...
func (PastaFpArithmetic) FromBytes(out *[native.FieldLimbs]uint64, arg *[native.FieldBytes]byte) {
	fiatPastaFpFromBytes(out, arg)
}

func (PastaFpArithmetic) ToBytes(out *[native.FieldBytes]byte, arg *[native.FieldLimbs]uint64) {
	fiatPastaFpToBytes(out, arg)
}

func (PastaFpArithmetic) Selectznz(out, arg1, arg2 *[native.FieldLimbs]uint64, choice int) {
...
var generator = [native.FieldLimbs]uint64{0xa1a55e68ffffffed, 0x74c2a54b4f4982f3, 0xfffffffffffffffd, 0x3fffffffffffffff}
