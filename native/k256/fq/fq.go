...
var (
	...
	k256FqParams   native.Field4Params
)

func K256FqNew() *native.Field4 {
...
func k256FqParamsInit() {
	k256FqParams = native.Field4Params{
		R:       [native.Field4Limbs]uint64{0x402da1732fc9bebf, 0x4551231950b75fc4, 0x0000000000000001, 0x0000000000000000},
		R2:      [native.Field4Limbs]uint64{0x896cf21467d7d140, 0x741496c20e7cf878, 0xe697f5e45bcd07c6, 0x9d671cd581c69bc5},
		R3:      [native.Field4Limbs]uint64{0x7bc0cfe0e9ff41ed, 0x0017648444d4322c, 0xb1b31347f1d0b2da, 0x555d800c18ef116d},
		Modulus: [native.Field4Limbs]uint64{0xbfd25e8cd0364141, 0xbaaedce6af48a03b, 0xfffffffffffffffe, 0xffffffffffffffff},
...
func getK256FqParams() *native.Field4Params {
...
func (k256FqArithmetic) ToMontgomery(out, arg *[native.Field4Limbs]uint64) {
...
func (f k256FqArithmetic) Sqrt(wasSquare *int, out, arg *[native.Field4Limbs]uint64) {
	...
	c5 := [native.Field4Limbs]uint64{0x944cf2a220910e04, 0x815c829c780589f4, 0x55980b07bc222113, 0xc702b0d248825b36}
...
func (f k256FqArithmetic) Invert(wasInverted *int, out, arg *[native.Field4Limbs]uint64) {
	// Using an addition chain from
	// https://briansmith.org/ecc-inversion-addition-chains-01#secp256k1_scalar_inversion
	var x1, x10, x11, x101, x111, x1001, x1011, x1101 [native.Field4Limbs]uint64
	var x6, x8, x14, x28, x56, tmp [native.Field4Limbs]uint64
...
func (k256FqArithmetic) FromBytes(out *[native.Field4Limbs]uint64, arg *[native.Field4Bytes]byte) {
	FromBytes(out, arg)
}

// ToBytes converts a field element to a little endian byte array.
func (k256FqArithmetic) ToBytes(out *[native.Field4Bytes]byte, arg *[native.Field4Limbs]uint64) {
	ToBytes(out, arg)
}

// Selectznz performs conditional select.
// selects arg1 if choice == 0 and arg2 if choice == 1.
func (k256FqArithmetic) Selectznz(out, arg1, arg2 *[native.Field4Limbs]uint64, choice int) {
...
var generator = &[native.Field4Limbs]uint64{0xc13f6a264e843739, 0xe537f5b135039e5d, 0x0000000000000008, 0x0000000000000000}
